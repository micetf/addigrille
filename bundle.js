...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _parametres = __webpack_require__(191);

	var _parametres2 = _interopRequireDefault(_parametres);

	var _plateau = __webpack_require__(299);

	var _plateau2 = _interopRequireDefault(_plateau);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_parametres2.default, null),
	                _react2.default.createElement(_plateau2.default, null)
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rcInputNumber = __webpack_require__(194);
	...
	var Parametres = function (_Component) {
	    _inherits(Parametres, _Component);

	    function Parametres(props) {
	        _classCallCheck(this, Parametres);

	        var _this = _possibleConstructorReturn(this, (Parametres.__proto__ || Object.getPrototypeOf(Parametres)).call(this, props));

	        _this.props.createGrille(_this.props.parametres);
	        _this.toggleCheckboxChange = _this.toggleCheckboxChange.bind(_this);
	        _this.refreshAddiGrille = _this.refreshAddiGrille.bind(_this);
	        return _this;
	    }

	    _createClass(Parametres, [{
	        key: 'componentDidUpdate',
	        value: function componentDidUpdate(prevProps) {
	            var parametres = this.props.parametres;
	            var prevParametres = prevProps.parametres;
	            var recreate = Object.keys(parametres).some(function (parametre) {
	        ...
	        key: 'refreshAddiGrille',
	        value: function refreshAddiGrille() {
	        ...
	        value: function render() {
	            ...
	            var on = this.props.correction ? 'on' : '';
	            console.log(on);
	            return _react2.default.createElement(
	                'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_rcInputNumber2.default, {
	                                ...
	                                onChange: function onChange(n) {
	                                    return _this2.props.changeParametre({ lignes: n });
	                                },
	                                parser: function parser(input) {
	                                    return Math.round(input) || _this2.props.parametres.lignes;
	                                },
	                                defaultValue: 2 })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_rcInputNumber2.default, {
	                                ...
	                                style: { width: 50 },
	                                parser: function parser(input) {
	                                    return Math.round(input) || _this2.props.parametres.colonnes;
	                                },
	                                onChange: function onChange(n) {
	                                    return _this2.props.changeParametre({ colonnes: n });
	                                },
	                                defaultValue: 2 })
	                        )
	                    )
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'bg-info' },
	                            'Valeur maximale des nombres \xE0 additionner',
	                            ' ',
	                            _react2.default.createElement(_rcInputNumber2.default, {
	                                min: 1,
	                                max: 1000,
	                                ...
	                                style: { width: 100 },
	                                parser: function parser(input) {
	                                    return Math.round(input) || _this2.props.parametres.ordre;
	                                },
	                                onChange: function onChange(n) {
	                                    return _this2.props.changeParametre({ ordre: n });
	                                },
	                                defaultValue: 10 })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(_rcInputNumber2.default, {
	                                ...
	                                style: { width: 50 },
	                                parser: function parser(input) {
	                                    return Math.round(input) || _this2.props.parametres.decimaux;
	                                },
	                                onChange: function onChange(n) {
	                                    return _this2.props.changeParametre({ decimaux: n });
	                                },
	                                defaultValue: 0 })
	                        )
	                    )
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement('span', { className: 'switch switch-toggle' })
	                            )
	                        )
	                    ),
	                    _react2.default.createElement(
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({
	        changeParametre: _actions.changeParametre,
	        setVisibilityCorrection: _actions.setVisibilityCorrection,
	        createGrille: _actions.createGrille
	    }, dispatch);
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Parametres);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.focusSaisie = exports.addTotal = exports.addSomme = exports.createGrille = exports.setVisibilityCorrection = exports.changeParametre = undefined;

	var _actionsTypes = __webpack_require__(193);

	var types = _interopRequireWildcard(_actionsTypes);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var changeParametre = exports.changeParametre = function changeParametre(parametre) {
	    return {
	...
	var setVisibilityCorrection = exports.setVisibilityCorrection = function setVisibilityCorrection() {
	    return {
	        type: types.SET_VISIBILITY_CORRECTION
	    };
	};

	var createGrille = exports.createGrille = function createGrille(parametres) {
	    return {
	...
	var addSomme = exports.addSomme = function addSomme(focus) {
	    return {
	...
	var addTotal = exports.addTotal = function addTotal(focus) {
	    return {
	...
	var focusSaisie = exports.focusSaisie = function focusSaisie(focus) {
	    return {
...
/***/ (function(module, exports) {
	...
	var CHANGE_PARAMETRE = exports.CHANGE_PARAMETRE = 'CHANGE_PARAMETRE';
	var CREATE_GRILLE = exports.CREATE_GRILLE = 'CREATE_GRILLE';
	var ADD_SOMME = exports.ADD_SOMME = 'ADD_SOMME';
	var ADD_TOTAL = exports.ADD_TOTAL = 'ADD_TOTAL';
	var SET_VISIBILITY_CORRECTION = exports.SET_VISIBILITY_CORRECTION = 'SET_VISIBILITY_CORRECTION';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _InputHandler = __webpack_require__(251);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rcTouchable = __webpack_require__(298);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(204)(IteratorPrototype, __webpack_require__(269)('iterator'), function(){ return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(200)
	  , hide          = __webpack_require__(204)
	  , Iterators     = __webpack_require__(263)
	  , TO_STRING_TAG = __webpack_require__(269)('toStringTag');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(222)
	  , gOPN      = __webpack_require__(285).f
	  , toString  = {}.toString;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(202)(Function.call, __webpack_require__(286).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Plateau = function (_Component) {
	    _inherits(Plateau, _Component);

	    function Plateau(props) {
	        _classCallCheck(this, Plateau);

	        var _this = _possibleConstructorReturn(this, (Plateau.__proto__ || Object.getPrototypeOf(Plateau)).call(this, props));
	        ...
	        _this.drawGrille = _this.drawGrille.bind(_this);
	    ...
	    _createClass(Plateau, [{
	        key: 'drawGrille',
	        value: function drawGrille() {
	            var _this2 = this;

	            var ctx = this.refs.canvas.getContext('2d');
	            var _state$canvas = this.state.canvas,
	                w = _state$canvas.w,
	                h = _state$canvas.h,
	                marge = _state$canvas.marge;
	            var _props$parametres = this.props.parametres,
	                lignes = _props$parametres.lignes,
	                colonnes = _props$parametres.colonnes;

	            var correction = this.props.correction;
	            var addi = this.props.addi;
	            var wCell = Math.round((w - 2 * marge) / (colonnes + 4));
	            var hCell = Math.round((h - 2 * marge) / (lignes + 2));
	            var taille = Math.floor(wCell / 4);

	            var writeNumber = function writeNumber(v, x, y) {
	                var d = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
	                var correction = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
	            ...
	            var drawArrow = function drawArrow(x, y, sens) {
	                ctx.beginPath();
	                ctx.moveTo(x, y);
	                switch (sens) {
	                    case 'T':
	            ...
	            var drawTotalColonnes = function drawTotalColonnes(_) {
	                var x = marge;
	                var y = marge + hCell * (lignes + 1);
	                var focus = _this2.props.saisie.focus;
	                ...
	                writeNumber(_this2.props.saisie.total.colonnes || '', x, y);
	                writeNumber(addi.total, x, y, hCell / 4, correction);

	                _this2.mapping.total.colonnes = { x: x, y: y, wCell: wCell, hCell: hCell };
	            };
	            var drawTotalLignes = function drawTotalLignes(_) {
	                var x = marge + wCell * (colonnes + 3);
	                var y = marge + hCell * (lignes + 1);
	                var focus = _this2.props.saisie.focus;
	                ...
	                ctx.strokeRect(x, y, wCell, hCell);
	                writeNumber(_this2.props.saisie.total.lignes || '', x, y);
	                writeNumber(addi.total, x, y, hCell / 4, correction);

	                _this2.mapping.total.lignes = { x: x, y: y, wCell: wCell, hCell: hCell };
	            };
	            ...
	            addi.grille.forEach(function (colonnes, l) {
	                colonnes.forEach(function (valeur, c) {
	                    var x = marge + (c + 2) * wCell;
	                    var y = marge + l * hCell;
	            ...
	            addi.sommes.lignes.forEach(function (valeur, l) {
	                var x = marge + (colonnes + 3) * wCell;
	                var y = marge + l * hCell;
	                var focus = _this2.props.saisie.focus;
	                ...
	                ctx.strokeRect(x, y, wCell, hCell);
	                writeNumber(_this2.props.saisie.sommes.lignes[l] || '', x, y);
	                writeNumber(valeur, x, y, hCell / 4, correction);

	                _this2.mapping.sommes.lignes[l] = { x: x, y: y, wCell: wCell, hCell: hCell };
	            });
	            addi.sommes.colonnes.forEach(function (valeur, c) {
	                var x = marge + (c + 2) * wCell;
	                var y = marge + (lignes + 1) * hCell;
	                var focus = _this2.props.saisie.focus;
	                ...
	                drawArrow(x + wCell / 2, y - hCell, 'B');
	                ctx.strokeRect(x, y, wCell, hCell);
	                writeNumber(_this2.props.saisie.sommes.colonnes[c] || '', x, y);
	                writeNumber(valeur, x, y, hCell / 4, correction);

	                _this2.mapping.sommes.colonnes[c] = { x: x, y: y, wCell: wCell, hCell: hCell };
	            });
	        ...
	        value: function onCanvasClick(e) {
	            ...
	            var is = function is(stage, sens) {
	                if (stage === 'total') {
	                    var coord = _this3.mapping[stage][sens];
	                    if (x < coord.x || x > coord.x + coord.wCell) return null;
	                    if (y < coord.y || y > coord.y + coord.hCell) return null;
	                    return { stage: stage, sens: sens };
	                }
	                return _this3.mapping[stage][sens].reduce(function (trouve, coord, index) {
	                    if (x < coord.x || x > coord.x + coord.wCell) return trouve;
	                    if (y < coord.y || y > coord.y + coord.hCell) return trouve;
	                    return { stage: stage, sens: sens, index: index };
	                }, null);
	            };
	            var focus = is('sommes', 'lignes') || is('sommes', 'colonnes') || is('total', 'lignes') || is('total', 'colonnes');
	        ...
	        value: function onInputChange(e) {
	            ...
	            var focus = this.props.saisie.focus;
	            if (focus.stage === 'sommes') {
	                this.props.addSomme(_extends({}, focus, { value: value }));
	            } else if (focus.stage === 'total') {
	                this.props.addTotal(_extends({}, focus, { value: value }));
	            }
	        }
	    }, {
	        key: 'onInputBlur',
	        ...
	        key: 'render',
	        value: function render() {
	            var input = this.props.saisie.focus ? this.props.saisie.focus.value || '' : '';
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({
	        focusSaisie: _actions.focusSaisie,
	        addSomme: _actions.addSomme,
	        addTotal: _actions.addTotal
	    }, dispatch);
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Plateau);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _parametresReducer = __webpack_require__(301);

	var _parametresReducer2 = _interopRequireDefault(_parametresReducer);

	var _addiReducer = __webpack_require__(302);

	var _addiReducer2 = _interopRequireDefault(_addiReducer);

	var _saisieReducer = __webpack_require__(303);

	var _saisieReducer2 = _interopRequireDefault(_saisieReducer);

	var _correctionReducer = __webpack_require__(304);

	var _correctionReducer2 = _interopRequireDefault(_correctionReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  parametres: _parametresReducer2.default,
	  addi: _addiReducer2.default,
	  saisie: _saisieReducer2.default,
	  correction: _correctionReducer2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { lignes: 3, colonnes: 3, ordre: 10, decimaux: 0, correction: false };
	    var action = arguments[1];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cellule = function cellule(ordre, puissance) {
	    return Math.floor(Math.random() * (ordre - 1) * puissance) / puissance;
	};
	var creerLigne = function creerLigne(colonnes, ordre, puissance) {
	    var ligne = [];
	...
	var addigrille = function addigrille(_ref) {
	    var lignes = _ref.lignes,
	        colonnes = _ref.colonnes,
	        ordre = _ref.ordre,
	        decimaux = _ref.decimaux;

	    var puissance = Math.pow(10, decimaux);
	    var addi = {
	        grille: [],
	        sommes: {
	            lignes: [],
	    ...
	    for (var l = 0; l < lignes; l++) {
	        var ligne = creerLigne(colonnes, ordre, puissance);
	        var somme = Math.round(ligne.reduce(function (s, v) {
	            return s + v * puissance;
	        }, 0)) / puissance;
	        ...
	        ligne.map(function (v, c) {
	            var somme = addi.sommes.colonnes[c] || 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var somme = function somme() {
	    ...
	    return [].concat(_toConsumableArray(state.slice(0, action.payload.index)), [action.payload.value], _toConsumableArray(state.slice(action.payload.index + 1)));
	};
	var sommes = function sommes() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { lignes: [], colonnes: [] };
	    var action = arguments[1];

	    return _extends({}, state, _defineProperty({}, action.payload.sens, somme(state[action.payload.sens], action)));
	};
	var total = function total() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { lignes: null, colonnes: null };
	    var action = arguments[1];

	    return _extends({}, state, _defineProperty({}, action.payload.sens, action.payload.value));
	};
